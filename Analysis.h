...
//REVISAR DESPUES SI HAY QUE HACER TO-DO DE NUEVO PARA EL DIJET2
  ...
  TH1F* plot_PT_b_dijet;
  TH1F* plot_ETA_b_dijet;
  TH1F* plot_M_b_dijet;
  TH1F* plot_PHI_b_dijet;
  TH1F* plot_DR_b_dijet;
  
  //plots of the dijet pairs that are not merged.
  TH1F* plot_PT_dijet_not;
  TH1F* plot_ETA_dijet_not;
  TH1F* plot_M_dijet_not;
  TH1F* plot_PHI_dijet_not;
  TH1F* plot_DR_dijet_not;
  ...
  TH1F* plot_PHI_dijet_partially;
  TH1F* plot_DR_dijet_partially;
  
  //plots of the dijet pairs that are fully merged.
  TH1F* plot_PT_dijet_fully;
  TH1F* plot_ETA_dijet_fully;
  TH1F* plot_M_dijet_fully;
  TH1F* plot_PHI_dijet_fully;
  TH1F* plot_DR_dijet_fully;
  
  //plots of the b_dijet pairs that are not merged.
  TH1F* plot_PT_b_dijet_not;
  TH1F* plot_ETA_b_dijet_not;
  TH1F* plot_M_b_dijet_not;
  TH1F* plot_PHI_b_dijet_not;
  TH1F* plot_DR_b_dijet_not;
  ...
  TH1F* plot_PHI_b_dijet_partially;
  TH1F* plot_DR_b_dijet_partially;
  ...
  TH1F* plot_PHI_b_dijet_fully;
  TH1F* plot_DR_b_dijet_fully;
 ...
 private:
	...
	//In the semi-leptonic, index_b2 makes reference to the b quark not used (the one coming from the leptonic decaying top).
 	MAuint32 index_b1;
 	MAuint32 index_b2;
 	//Four-momentum of the reconstructed W (dijet) and top quark (b_dijet).
	...
	//Remember jets has 4 jets in this channel.
 	void MergedFullyHadronic(std::vector<const MCParticleFormat*> jets, std::vector<const MCParticleFormat*> b, MA5::MALorentzVector &dijet, MA5::MALorentzVector &b_dijet){
		...
		for (MAuint32 i = 0; i < 2; i++){
			...
			if (dR_dijet > 0.8){
				...
				const MALorentzVector p_b = b[indexesb[i]]->momentum();
				b_dijet = p_b + dijet;
	...
	void MergedSemiLeptonic(std::vector<const MCParticleFormat*> jets, std::vector<const MCParticleFormat*> b, MA5::MALorentzVector &dijet, MA5::MALorentzVector &b_dijet){
		...
		if (dR_dijet > 0.8){
			...
			index_b2 = 1 - index_b1;
			b_dijet = b[index_b1]->momentum() + dijet;
