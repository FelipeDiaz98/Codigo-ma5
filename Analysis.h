 ...
 private:
	...
	//Organizes the final state vectors in terms of their PT (greatest to smallest).
      	...
      	Double_t Charge(const MCParticleFormat* particle){
 			...
 			if ((particle->pdgid()==2) || (particle->pdgid()==4) || (particle->pdgid()==6)){
 				charge = 2.0/3.0;
 			}
 			...
 			//If the particle is an electron.
      			if ((particle->pdgid()==11) || (particle->pdgid()==13) || (particle->pdgid()==15)){
 				charge = -1.0;
 			}
 			...
 			//If the particle is a neutrino or anti-neutrino.
      			if ((particle->pdgid()==12) || (particle->pdgid()==14) || (particle->pdgid()==16) || (particle->pdgid()==-12) || (particle->pdgid()==-14) || (particle->pdgid()==-16)){
 				charge = 0.0;
 			}
      		}
      		return charge;
